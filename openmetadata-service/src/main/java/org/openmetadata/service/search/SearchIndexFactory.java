...
import org.openmetadata.service.search.indexes.InstanceCodeIndexKbCust;
...
import org.openmetadata.service.search.indexes.ReportProjectIndexKbCust;
...
public class SearchIndexFactory {
  ...
  public SearchIndex buildIndex(String entityType, Object entity) {
    return switch (entityType) {
      ...
      case Entity.INSTANCE_CODE -> new InstanceCodeIndexKbCust((InstanceCode) entity);
      case Entity.REPORT_PROJECT -> new ReportProjectIndexKbCust((ReportProject) entity);
